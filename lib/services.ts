...
export const services: Service[] = [
  ...
  },
  {
    ...
    intro:
      "Industrial wastewater management is the end-to-end handling of process water and sludge, collection, transport, treatment, and disposal. Cowart does all four under a single DOT number, with no third-party handoffs.",
    content: [
  ...
  },
  {
    ...
    intro:
      "Oil-water separator service is the scheduled cleaning of OWS units, quarterly oil removal and annual full pump-outs, for gas stations, repair shops, fleet yards, and industrial facilities, disposed at Cowart's own treatment plant under one DOT number.",
    content: [
  ...
  },
  {
    ...
    intro:
      "Industrial waste disposal is the end-to-end removal of non-hazardous waste, profiling, transport, treatment, manifests, and proof of disposition. Cowart handles it for both scheduled pickups and one-time projects.",
    content: [
  ...
  },
  {
    ...
    intro:
      "Dump-trailer service is the haul-off of loose bulk material in end-dump trailers, loaded on site, transported under our DOT number, and tipped at the disposal facility. The right tool when a load is too loose for a roll-off and too solid for a tanker.",
    content: [
  ...
  },
  {
    ...
    intro:
      "An air mover is a high-power industrial vacuum that moves dry solids, sand, dust, dewatered cake, fly ash, catalyst, and powders, pneumatically, fast, and without water or chemicals.",
    content: [
  ...
  },
  {
    ...
    intro:
      "A vacuum box is a sealed, roll-off-style container for liquid containment and sludge staging, used on project work where a standard roll-off won't hold the load and a tanker is the wrong shape.",
    content: [
  ...
  },
  {
    ...
    intro:
      "A frac tank is large-capacity, on-site liquid storage, for process water, wastewater, project staging, hydroblasting feed, and containment during facility turnarounds, drill sites, and emergency response.",
    content: [
  ...
  // ───────────────────────── INDUSTRIAL CLEANING ──────────────────────────
  {
    ...
    intro:
      "Industrial cleaning is the removal of process buildup, residue, and contamination from plant equipment, from routine maintenance through major turnarounds, handled by HAZWOPER-40 and OSHA-30 crews with confined-space credentials, backed by Cowart's own treatment plant in Carrollton, GA.",
    content: [
  ...
  },
  {
    ...
    intro:
      "Industrial hydroblasting is water-only material removal at up to 40,000 PSI, it descales, strips, and surface-preps industrial equipment without chemicals, abrasives, or secondary waste.",
    content: [
  ...
  },
  {
    ...
    intro:
      "Line jetting is high-pressure water cleaning of pipes and process lines, it clears blockages, scale, grease, and buildup with no chemicals and no disassembly, restoring full flow while dislodged material is recovered and disposed.",
    content: [
  ...
  // ────────────────────────── ON-SITE TREATMENT ───────────────────────────
  {
    ...
    intro:
      "On-site filtration is mobile water treatment at the point of generation, filtration trailers, on-site sampling, and discharge support that cut transport costs and downtime while including full compliance documentation, across the Southeast.",
    content: [
